...
var CompositeFilter = class _CompositeFilter extends Filter {
  ...
  getFlattenedFilters() {
    return null !== this.v || (this.v = this.filters.reduce((t, e) => t.concat(e.getFlattenedFilters()), [])), this.v;
  }
...
var __PRIVATE_TargetImpl = class {
  constructor(t, e = null, r = [], n = [], i = null, s = null, o = null) {
    this.path = t, this.collectionGroup = e, this.orderBy = r, this.filters = n, this.limit = i, this.startAt = s, this.endAt = o, this.D = null;
  }
};
...
var __PRIVATE_QueryImpl = class {
  ...
  constructor(t, e = null, r = [], n = [], i = null, s = "F", o = null, a = null) {
    this.path = t, this.collectionGroup = e, this.explicitOrderBy = r, this.filters = n, this.limit = i, this.limitType = s, this.startAt = o, this.endAt = a, this.C = null, // The corresponding `Target` of this `Query` instance, for use with
    // non-aggregate queries.
    this.S = null, // The corresponding `Target` of this `Query` instance, for use with
...
function __PRIVATE_queryNormalizedOrderBy(t) {
  ...
  if (null === e.C) {
    ...
    for (const r2 of e.explicitOrderBy) e.C.push(r2), t2.add(r2.field.canonicalString());
    ...
    n.forEach((n2) => {
      t2.has(n2.canonicalString()) || n2.isKeyField() || e.C.push(new OrderBy(n2, r));
    }), // Add the document key field to the last if it is not explicitly ordered.
    t2.has(FieldPath$1.keyField().canonicalString()) || e.C.push(new OrderBy(FieldPath$1.keyField(), r));
  }
  return e.C;
}
function __PRIVATE_queryToTarget(t) {
  const e = __PRIVATE_debugCast(t);
  return e.S || (e.S = __PRIVATE__queryToTarget(e, __PRIVATE_queryNormalizedOrderBy(t))), e.S;
}
...
var __PRIVATE_DatastoreImpl = class extends class Datastore {
  ...
  P(t, e, r, n) {
    return this.Y(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([i, s]) => this.connection.P(t, __PRIVATE_toResourcePath(e, r), n, i, s)).catch((t2) => {
  ...
  g(t, e, r, n, i) {
    return this.Y(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([s, o]) => this.connection.g(t, __PRIVATE_toResourcePath(e, r), n, s, o, i)).catch((t2) => {
      throw "FirebaseError" === t2.name ? (t2.code === p && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), t2) : new FirestoreError(A, t2.toString());
    });
  }
  terminate() {
...
async function __PRIVATE_invokeRunAggregationQueryRpc(t, e, r) {
  var n;
  const i = __PRIVATE_debugCast(t), { request: s, Z: o, parent: a } = function __PRIVATE_toRunAggregationQueryRequest(t2, e2, r2, n2) {
    const { q: i2, parent: s2 } = __PRIVATE_toQueryTarget(t2, e2), o2 = {}, a2 = [];
    let u2 = 0;
    ...
    return e2.N || // Do not include implicit order-bys for aggregate queries.
    (e2.N = __PRIVATE__queryToTarget(e2, t2.explicitOrderBy)), e2.N;
  }(e), r);
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(t) {
    if (2 !== t.tt) throw 1 === t.tt ? t.ut(`${this._methodName}() can only appear at the top level of your update data`) : t.ut(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
var __PRIVATE_ArrayUnionFieldValueImpl = class ___PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  isEqual(t) {
    return t instanceof ___PRIVATE_ArrayUnionFieldValueImpl && deepEqual(this.ht, t.ht);
  }
};
var __PRIVATE_ArrayRemoveFieldValueImpl = class ___PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
  ...
  isEqual(t) {
    return t instanceof ___PRIVATE_ArrayRemoveFieldValueImpl && deepEqual(this.ht, t.ht);
  }
};
var __PRIVATE_NumericIncrementFieldValueImpl = class ___PRIVATE_NumericIncrementFieldValueImpl extends FieldValue {
  ...
  isEqual(t) {
    return t instanceof ___PRIVATE_NumericIncrementFieldValueImpl && this.dt === t.dt;
  }
};
...
function __PRIVATE_parseData(t, e) {
  ...
  if (t instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(t2, e2) {
      if (!__PRIVATE_isWrite(e2.tt)) throw e2.ut(`${t2._methodName}() can only be used with update() and set()`);
      if (!e2.path) throw e2.ut(`${t2._methodName}() is not currently supported inside arrays`);
  ...
  if (
    ...
    if (e.settings.nt && 4 !== e.tt) throw e.ut("Nested arrays are not supported");
  ...
  return function __PRIVATE_parseScalarValue(t2, e2) {
    ...
    if (t2 instanceof DocumentReference) {
      ...
      if (!n.isEqual(r)) throw e2.ut(`Document reference is for database ${n.projectId}/${n.database} but should be for database ${r.projectId}/${r.database}`);
      return {
              ...
              value: {
                arrayValue: {
                  values: t3.toArray().map((t4) => {
                    if ("number" != typeof t4) throw e3.ut("VectorValues must only contain numeric values.");
...
var __PRIVATE_TransactionRunner = class {
  ...
  Pt(t) {
    this.ft > 0 && this.Vt(t) ? (this.ft -= 1, this.asyncQueue.enqueueAndForget(() => (this.Tt(), Promise.resolve()))) : this.deferred.reject(t);
  }
  Vt(t) {
...
var __PRIVATE_AsyncQueueImpl = class {
  constructor(t = Promise.resolve()) {
    this.It = [], // Is this AsyncQueue being shut down? Once it is set to true, it will not
    // be changed again.
  ...
  enqueue(t) {
    ...
    return this.Nt(() => this.yt && this.vt ? Promise.resolve() : (t().then(e.resolve, e.reject), e.promise)).then(() => e.promise);
  }
  enqueueRetryable(t) {
  ...
  async Ot() {
    if (0 !== this.It.length) {
      ...
      this.It.length > 0 && // If there are additional operations, we re-schedule `retryNextOp()`.
  ...
  Nt(t) {
    const e = this.Ct.then(() => (this.Ft = true, t().catch((t2) => {
  ...
  enqueueAfterDelay(t, e, r) {
    this.St(), // Fast-forward delays for timerIds that have been overridden.
    this.Dt.indexOf(t) > -1 && (e = 0);
    const n = DelayedOperation.createAndSchedule(this, t, e, r, (t2) => this.qt(t2));
  ...
  Qt(t) {
    return this.Bt().then(() => {
      ...
      for (const e of this.wt) if (e.skipDelay(), "all" !== t && e.timerId === t) break;
      return this.Bt();
    });
  }
  /**
...
function runTransaction(t, e, r) {
  ...
  }(), n, i, (r2) => e(new Transaction(t, r2)), s).At(), s.promise;
}
